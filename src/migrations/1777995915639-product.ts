...
export class Product1777995915639 implements MigrationInterface {
    name = 'Product1777995915639'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "product" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" text NOT NULL, "price" double precision NOT NULL, "description" text, "slug" text NOT NULL, "stock" integer NOT NULL DEFAULT '1', "sizes" text array, "gender" text, "image" text NOT NULL, "categoryId" integer, "userId" uuid, CONSTRAINT "UQ_f7bf944ad9f1034110e8c2133ab" UNIQUE ("title"), CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
